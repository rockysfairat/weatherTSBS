...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex w-full h-screen justify-evenly items-center bg-treesBg flex-col dark:bg-darkTrees bg-center transition duration-1000">
      <Head>
      ...
      <button
        className="rounded-full border-solid border-4 border-zinc-900 dark:border-slate-50 px-1 py-1 backdrop-blur"
